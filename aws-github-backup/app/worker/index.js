...
// src/github.ts
async function getGithubRepoList(event) {
...
async function fetchAllRepoList(gql, login) {
  const repos = [];
  let after = "";
  do {
...
async function fetchRepoConnections(gql, params) {
...
// src/index.ts
async function main() {
  await getGithubRepoList({ githubOwner: "mseninc" });
}
main();
